    ...
    public static class Amount {
        ...
        public String formatAsDecimalSpaced() {
            if (isRound()) {
                ...
                switch (currency) {
                    case STARS:
                        return LocaleController.formatString("StarsCount", asDecimalString());
                    case TON:
                        return LocaleController.formatString("TonCount", asDecimalString());
                }
            }
        ...
        public Amount convertTo(Currency currency) {
            ...
            if (currency == Currency.STARS) {
                return fromDecimal(usd * 100 / 1 * 1000, currency);
            } else if (currency == Currency.TON) {
                return fromDecimal(usd / 1, currency);
            } else {
